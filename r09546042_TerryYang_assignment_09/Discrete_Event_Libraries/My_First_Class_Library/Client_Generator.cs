...
namespace Random_Variate_Generator_Library
{
    public class Client_Generator
    {
        ...
        public int Generated_Clients { get => generated_Clients;}
        #endregion

        #region Public Interfacing Function
        public Client_Generator(List<Service_Node>[] itineraries, double[] relative_Probabilities,double cease_Time)
        {
        ...
        public Discrete_Event Generate_A_Client_Arrival(double current_Time)
        {
            ...
            if (generated_Clients >= number_Of_Clients)
            {
                return null;
            }
            else
